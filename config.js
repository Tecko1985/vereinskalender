    ...
    groups: [
      {
        ...
        items: [
          "Jede Terminkarte zeigt jetzt, von wem und wann der Termin angelegt wurde (sofern diese Angabe vorliegt)."
        ]
      }
    ]
  },
    ...
    groups: [
      {
        ...
        items: [
          "Neuer Button (👥) je Terminvorschlag zeigt die Namen der Zu- und Absagen an."
        ]
      }
    ]
  },
